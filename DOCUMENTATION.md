...
- [Overview](#overview)
- [What is Bypass Paywalls Clean?](#what-is-bypass-paywalls-clean)
- [Repository Structure](#repository-structure)
- [Key Files Explained](#key-files-explained)
  - [README.md](#readmemd)
  - [changelog.txt](#changellogtxt)
  - [allowlist/README.md](#allowlistreadmemd)
  - [LICENSE](#license)
  - [release-hashes.txt](#release-hashestxt)
- [Extension Features](#extension-features)
  - [Core Functionality](#core-functionality)
  - [Bypass Techniques](#bypass-techniques)
  - [Permission Model](#permission-model)
- [Supported Website Categories](#supported-website-categories)
  - [News & Media](#news--media)
  - [Geographic Coverage](#geographic-coverage)
  - [Publisher Groups](#publisher-groups)
- [Installation Methods](#installation-methods)
  - [Method 1: Load Unpacked](#method-1-load-unpacked-developer-mode)
  - [Method 2: CRX File](#method-2-crx-file)
  - [Method 3: Mobile](#method-3-mobile-kiwi-browser)
...
- [Browser Compatibility](#browser-compatibility)
  ...
  - [iOS/iPadOS Users](#iosipados-users)
- [Legal & Ethical Considerations](#legal--ethical-considerations)
  - [License](#license-1)
  - [Disclaimer](#disclaimer)
  - [Not on Official Stores](#not-on-official-stores)
...
- [Technical Architecture](#technical-architecture)
  ...
  - [Bypass Strategy](#bypass-strategy)

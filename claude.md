...
- [Critical Context](#critical-context)
  - [This is NOT a Code Repository](#this-is-not-a-code-repository)
  - [Security & Legal Considerations](#security--legal-considerations)
  - [Ethical Considerations](#ethical-considerations)
- [Repository Structure](#repository-structure)
- [Key Files Deep Dive](#key-files-deep-dive)
  - [README.md (Primary Documentation)](#readmemd-primary-documentation)
  - [changelog.txt (Version History)](#changellogtxt-version-history)
  - [allowlist/README.md (Allowlist Guide)](#allowlistreadmemd-allowlist-guide)
- [Supported Sites Analysis](#supported-sites-analysis)
  - [Geographic Distribution](#geographic-distribution)
  - [Category Distribution](#category-distribution)
  - [Publisher Groups](#publisher-groups)
- [Extension Features (Documented)](#extension-features-documented)
  - [Bypass Techniques](#bypass-techniques)
  - [User Configuration](#user-configuration)
- [Common Tasks & Guidance](#common-tasks--guidance)
  - [Updating the Supported Sites List](#updating-the-supported-sites-list)
  - [Fixing Documentation Typos](#fixing-documentation-typos)
  - [Answering User Questions](#answering-user-questions)
  - [Version Information](#version-information)
- [Development Activity Insights](#development-activity-insights)
  - [Update Frequency](#update-frequency)
  - [Common Change Types](#common-change-types)
  - [Recent Major Changes (2024)](#recent-major-changes-2024)
  - [Active Maintenance Indicators](#active-maintenance-indicators)
- [Browser Compatibility](#browser-compatibility)
  - [Fully Supported](#fully-supported)
  - [Separate Version](#separate-version)
  - [Limited Support](#limited-support)
  - [Installation Methods by Browser](#installation-methods-by-browser)
- [Distribution Strategy](#distribution-strategy)
  - [Why Not Chrome Web Store?](#why-not-chrome-web-store)
  - [Why GitFlic?](#why-gitflic)
  - [Update Mechanisms](#update-mechanisms)
- [Testing & Quality Assurance](#testing--quality-assurance)
  - [Before Reporting Bugs](#before-reporting-bugs)
  - [Issue Reporting Requirements](#issue-reporting-requirements)
- [Working with This Repository](#working-with-this-repository)
  - [Safe Changes](#safe-changes)
  - [Changes Requiring Caution](#changes-requiring-caution)
  - [Changes to Avoid](#changes-to-avoid)
- [Useful Commands for Analysis](#useful-commands-for-analysis)
- [Project Governance](#project-governance)
  - [Maintainer](#maintainer)
  - [Community](#community)
  - [Contribution Model](#contribution-model)
- [Key Takeaways for AI Assistants](#key-takeaways-for-ai-assistants)
